...
class Semester(db.Model):
    ...
    offered_courses = db.relationship('CourseOffering', backref='semester', lazy='dynamic')
...
def to_json(self):
    return {
        ...
        "offered_courses": [course.to_json() for course in self.offered_courses]  # Include offered courses
    }
