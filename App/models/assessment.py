...
class Assessment(db.Model):
    ...
    course_offering_id = db.Column(db.Integer, db.ForeignKey('courseOffering.id'), nullable=False) 
    ...
    # relationships
    course_offering = db.relationship('CourseOffering', backref='assessments', lazy='joined')
    category = db.relationship('Category', backref='assessments', lazy='joined')
