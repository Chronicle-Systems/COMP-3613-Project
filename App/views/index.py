...
def init():
    ...
    # create semester
    sem = Semester(startDate='01-02-2024', endDate='01-05-2024',
                   semNum=1, maxAssessments=3)
    db.session.add(sem)

    # create courses
    c1 = Course(courseCode='COMP1700', courseTitle='Introduction to C++',
                description='C++ basics', level=1, semester=1, aNum=3)
    c2 = Course(courseCode='COMP1701', courseTitle='Introduction to Web Development',
                description='Web development basics', level=1, semester=1, aNum=3)
    c3 = Course(courseCode='COMP2700', courseTitle='Advanced C++',
                description='Advanced C++', level=2, semester=1, aNum=3)
    c4 = Course(courseCode='COMP2701', courseTitle='Advanced Web Development',
                description='Advanced web development', level=2, semester=1, aNum=3)
    c5 = Course(courseCode='COMP3700', courseTitle='Data Science Fundamentals',
                description='Introduction to python and datasets', level=3, semester=1, aNum=3)
    c6 = Course(courseCode='COMP3701', courseTitle='Advanced Data Science',
                description='Analyzing Big Data with Python', level=3, semester=1, aNum=3)
    db.session.add(c1)
    db.session.add(c2)
    db.session.add(c3)
    db.session.add(c4)
    ...
    # create staff
    staff = Staff.register(firstName='Jane', lastName='Doe', u_ID=11111111,
                           status='Lecturer', email='jane@mail.com', password='password')
